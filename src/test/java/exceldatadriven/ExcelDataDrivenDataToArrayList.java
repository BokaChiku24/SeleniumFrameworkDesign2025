...
public class ExcelDataDrivenDataToArrayList {
        ...
        while (row.hasNext()) {
            ...
            if (firstRow.getCell(column).getStringCellValue().equalsIgnoreCase(testCaseName)) {
                ...
                while (cell.hasNext()) {
                    ...
                    obj.add(cell.next().getStringCellValue());
                }
            }
        }
        return obj;
    ...
    public static void main(String[] args) throws IOException {
        ArrayList<String> obj = ExcelDataDrivenDataToArrayList.getData("TestExcel","Test1","Purchase");
